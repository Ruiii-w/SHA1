...
void shaTran(unsigned char * buf,unsigned int * state)
{
    ...
    unsigned int tmpA,tmpB,tmpC,tmpD,tmpE;
    ...
    for(i=16;i<80;i++)
    {
        ...
        unsigned int tmp1 = W[i] << 1;
        unsigned int tmp2 = W[i] >> 31;
        W[i] = tmp1 | tmp2;
    }
    ...
    for(i=0;i<20;i++)
    {
        ...
        tmpD = D;
        tmpE = E;
        A = (tmpE + f1(tmpB,tmpC,tmpD)+ ((A << 5) | (A >>27))+W[i]+K[0]) ;
        A &= 0xFFFFFFFF;
        B = tmpA;
        C = tmpB << 30 | tmpB >> 2;
        D = tmpC;
    ...
    for(i=20;i<40;i++)
    {
       //TODO  需要添加代码
        ...
        tmpD = D;
        tmpE = E;
        A = (tmpE + f2(tmpB,tmpC,tmpD)+ ((A << 5) | (A >>27))+W[i]+K[1]) ;
        A &= 0xFFFFFFFF;
        B = tmpA;
        C = tmpB << 30 | tmpB >> 2;
        D = tmpC;
    ...
    for(i=40;i<60;i++)
    {
       //TODO  需要添加代码
        ...
        tmpD = D;
        tmpE = E;
        A = (tmpE + f3(tmpB,tmpC,tmpD)+ ((A << 5) | (A >>27))+W[i]+K[2]) ;
        A &= 0xFFFFFFFF;
        B = tmpA;
        C = tmpB << 30 | tmpB >> 2;
        D = tmpC;
    ...
    for(i=60;i<80;i++)
    {
       //TODO  需要添加代码
        ...
        tmpD = D;
        tmpE = E;
        A = (tmpE + f4(tmpB,tmpC,tmpD)+ ((A << 5) | (A >>27))+W[i]+K[3]) ;
        A &= 0xFFFFFFFF;
        B = tmpA;
        C = tmpB << 30 | tmpB >> 2;
        D = tmpC;
...
int main()
{
    ...
    char* a = "9b6390a2282783b6d8ebda199f104fe83df3015c";
    char* b = "6fefa324ee16c4779cb2aeb25c1afdcd2e9cd559";
    printf("len %d\n",strlen(a));
    int count = 0;
